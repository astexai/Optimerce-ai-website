    ...
    <section className="py-24 md:py-32 flex items-center justify-center">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="glass rounded-2xl p-8">
          ...
          <h1 className="font-display text-2xl font-bold text-center mb-2">Start your free trial</h1>
          <p className="text-sm text-muted-foreground text-center mb-6">Join 2,000+ brands using Optimerce AI</p>
          ...
          <div className="space-y-4">
            ...
            <Button className="w-full gradient-bg border-0" size="lg">Create Account</Button>
          </div>
